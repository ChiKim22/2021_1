...
//		test1();
	...
	public static void test1() {
		 ...
		 * Map 객체 생성
		 * HashMap으로 생성
		 * 맵은 <key, value> 의 쌍으로 저장하며, key값을 통해 인출한다.
		 * Map는 Generic 인터페이스이며 이를 구현한 HashMap, TreeMap, LinkedHashMap 클래스들은
		 * 제네릭 클래스이다. 즉 객체를 생성할때 타입을 지정해주어야 한다.
		 */
...
//		map = new TreeMap();
		...
		/*
		 * map 이라는 자료구조에 들어가 있는 모든 원소들을 다 읽을 수 있는 방법은 2가지다.
		 * 1. map에게 가진 원소의 모든 키 집합을 요청하고, 그 집합의 각 원소를 가지고 map에 값을 요청하는 방법.
		 * 2. map에게 <key, value> 쌍으로 저장된 엔트리 집합을 요청해서그 집합의 원소를 하나씩 읽는 방법.
		 */
...
//		}
	...
	public static void test2() {
		 ...
		 * <name, PhoneNo> "Kim", "010-1234-5678"
		 */
